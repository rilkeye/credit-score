...
params_test1={
    ...
    'num_leaves': range(84, 88)  # range(30, 120, 10)
}
...
# -------------------------------------------------------------
# 'max_depth': 7, 'num_leaves': 86
# best_score : -14.653121422908281
'''
...
params_test3={
    'min_child_samples': [46],
    'min_child_weight': [0.005, 0.01, 0.015]
}
model_lgb = lgb.LGBMRegressor(**params)
...
print('best n_estimators:', len(cv_results['l1-mean']))
print('best cv score:', cv_results['l1-mean'][-1])
# best n_estimators: 2319
# best cv score: 14.681625047542374
# -------------------------------------------------------------
'''
...
# 'max_bin': 383
# best cv score:-14.653121422908281
# -------------------------------------------------------------
'''
